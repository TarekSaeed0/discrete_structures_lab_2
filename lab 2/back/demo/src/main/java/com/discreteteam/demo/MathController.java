...
public class MathController {
    ...
    public ResponseEntity<Map<Integer, Integer>> getPrimeFactors(@PathVariable int n) {
        if (n <= 0) {
    ...
    public ResponseEntity<Integer> gcdEuclidean(@PathVariable int a, @PathVariable int b) {
        if (a <= 0 || b <= 0) {
    ...
    public ResponseEntity<Integer> lcmEuclidean(@PathVariable int a, @PathVariable int b) {
        if (a <= 0 || b <= 0) {
            return ResponseEntity.badRequest().body(0);
        }
    ...
    public ResponseEntity<Integer> gcdPrimeFactors(@PathVariable int a, @PathVariable int b) {
        if (a <= 0 || b <= 0) {
            return ResponseEntity.badRequest().body(0);
        }
    ...
    public ResponseEntity<Integer> lcmPrimeFactors(@PathVariable int a, @PathVariable int b) {
        if (a <= 0 || b <= 0) {
            return ResponseEntity.badRequest().body(0);
        }
